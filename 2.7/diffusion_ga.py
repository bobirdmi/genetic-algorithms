...
class DiffusionGA(object):
    ...
    def _find_critical_values(self, fitness_arr):
        ...
        if arr_dim > 2:
            raise ValueError(u'Only 1D or 2D arrays are supported.')

        if self._ga.optim == u'min':
